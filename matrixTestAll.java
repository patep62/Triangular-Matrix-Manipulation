...
public class matrixTestAll {
	...
	@Test
	public void testConstructor1_mytest() {
		// for constructor1
		int invalid_row1 = -100, invalid_col1 = 0;
	...
	@Test
	public void testConstructor2_mytest() {
	  // for constructor2
    int[][] data = {{1,2,3,4,5},{0,0,0,0,0},{0,0,1,2,3},{0,0,0,4,5}};
		Matrix f = new Matrix(data);
	...
	@Test
	public void testGetElement_mytest() {
	  // for constructor2
    int[][] data = {{1,2,3,4,5},{6,7,8,9,0},{0,0,1,2,3},{0,0,0,4,5}};
		Matrix f = new Matrix(data);
		String actual ="Empty for Now";
		try {
			int output = f.getElement(50, -2);	// invalid indexes
		}
		catch (IndexOutOfBoundsException e){
			 actual = e.getMessage();
		}
	...
	@Test
	public void testSetElement_mytest() {
	  int value = 100;
	  int setinvalid_row = 100, setinvalid_col = -10;
    int[][] data = {{1,2,3,4,5},{6,7,8,9,0},{0,0,1,2,3},{0,0,0,4,5}};
		Matrix f = new Matrix(data);
		boolean check = f.setElement(value,setinvalid_row,setinvalid_col);
		String expected= "1 2 3 4 5 \n"+"6 7 8 9 0 \n"+"0 0 1 2 3 \n"+"0 0 0 4 5 \n";
	...
	@Test
	public void testAddTo_mytest() {
		 int[][] add_to_data = {{3}, {1}, {0},{1}}; // add to 'data' matrix, dimension not match
	...
	@Test
	public void testSubMatrix_mytest() {

    int subinvalid_row = -2, valid_col = 3;
	  ...
	  int[][] data = {{1,2,3,4,5},{6,7,8,9,0},{0,0,1,2,3},{0,0,0,4,5}};
		...
		try{
			Matrix y = f.subMatrix(subinvalid_row,valid_col);
		}
		catch (ArithmeticException e){
	...
	@Test
	public void testIsUpperTr_mytest() {

    int[][] notUpper1 = {{3,9,6,-4},{0,0,0,0},{3,0,5,7}};    
	...
	@Test
	public void testSum_mytest() {
    int size=4;
    Matrix[] arr = new Matrix[size];
    for(int i=0; i<size; i++)
      arr[i]=new Matrix(-2,3);
    arr[2]= new Matrix(2,3);   // invalid, due to dimension do not match
	...
	@Test
	public void testUpperConstructor1_mytest() {
	...
	@Test
	public void testUpperConstructor2_mytest() {
		int[][] notupp = {{0,0,0},{2,2,0},{0,1,0}};
		Matrix not = new Matrix(notupp);
	...
	@Test
	public void testUpperGetDim_mytest() {
		int[][] con2_11 = {{1,2},{0,4}};
		Matrix con2_1 = new Matrix(con2_11);
		UpperTriangularMatrix m3 = new UpperTriangularMatrix(con2_1);
		int expected=2;
	...
	@Test
	public void testUpperGetElement_mytest() {
	  // for constructor2
		int[][] con2_11 = {{1,2,3,4,5},{0,6,7,8,9},{0,0,10,11,12},{0,0,0,13,14},{0,0,0,0,15}};
		Matrix con2_1 = new Matrix(con2_11);
		UpperTriangularMatrix m3 = new UpperTriangularMatrix(con2_1);
		String actual ="Empty for Now";
		try {
			int output = m3.getElement(-5, -5);	// invalid indexes
		}
		catch (IndexOutOfBoundsException e){
			 actual = e.getMessage();
		}
	...
	public void testUpperSetElement_mytest() {
		  int value = 100;
		  int setvalid_row = 2, setinvalid_col = -5;
		  int[][] con2_11 = {{1,2,3,4,5},{0,6,7,8,9},{0,0,10,11,12},{0,0,0,13,14},{0,0,0,0,15}};
		  Matrix con2_1 = new Matrix(con2_11);
		  String actual ="Empty for Now";
		  UpperTriangularMatrix m3 = new UpperTriangularMatrix(con2_1);
		  ...
		  try{
			  m3.setElement(value,setvalid_row,setinvalid_col);
		  }
		  catch (IndexOutOfBoundsException e){
				 actual = e.getMessage();
			}
	...
	@Test
	public void testUpperFullMatrix_mytest() {

	  int[][] con2_11 = {{-1,2,3,4,5},{0,6,7,8,9},{0,0,10,11,12},{0,0,0,13,14},{0,0,0,0,1}};
	  Matrix con2_1 = new Matrix(con2_11);
	  UpperTriangularMatrix m3 = new UpperTriangularMatrix(con2_1);
	  
	  int expected=-1*6*10*13*1;
	  assertEquals(expected,m3.getDet()); 
